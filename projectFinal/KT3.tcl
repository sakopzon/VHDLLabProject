...
#   set_location_assignment	PIN_W26  -to KEY[3]  ;# KEY3				;#	Reserved
   ...
   set_location_assignment PIN_N25  -to Turbo[0]   ;# SW0					;#	Reserved				
   set_location_assignment PIN_N26  -to Turbo[1]   ;# SW1					;#	Reserved
...
#   set_location_assignment PIN_AE22  -to which_freq[0] ;# LEDG0				;# Used for indication of reset keypress
#   set_location_assignment PIN_AF22  -to which_freq[1] ;# LEDG1				;#	Reserved
#   set_location_assignment PIN_W19   -to which_freq[2];# LEDG2				;#	Reserved
...
#   set_location_assignment PIN_Y12   -to LEDG[8] ;# LEDG8				;#	Reserved
   ...
   set_location_assignment PIN_AE23  -to shine[0]   ;# LEDR0				;#	Used for indication of slide switch #0
   set_location_assignment PIN_AF23  -to shine[1]   ;# LEDR1				;#	Used for indication of slide switch #1
   set_location_assignment PIN_AB21  -to shine[2]   ;# LEDR2				;#	Used for indication of slide switch #2
   set_location_assignment PIN_AC22  -to shine[3]   ;# LEDR3				;#	Used for indication of slide switch #3
   set_location_assignment PIN_AD22  -to shine[4]   ;# LEDR4				;#	Used for indication of slide switch #4
   set_location_assignment PIN_AD23  -to shine[5]   ;# LEDR5				;#	Used for indication of slide switch #5
   set_location_assignment PIN_AD21  -to shine[6]   ;# LEDR6				;#	Used for indication of slide switch #6
   set_location_assignment PIN_AC21  -to shine[7]   ;# LEDR7				;#	Used for indication of slide switch #7
   set_location_assignment PIN_AA14  -to shine[8]   ;# LEDR8				;#	Used for indication of slide switch #8
   set_location_assignment PIN_Y13   -to shine[9]   ;# LEDR9				;#	Used for indication of slide switch #9
   set_location_assignment PIN_AA13  -to shine[10]  ;# LEDR10			;#	Used for indication of slide switch #10
   set_location_assignment PIN_AC14  -to shine[11]  ;# LEDR11			;#	Used for indication of slide switch #11
   set_location_assignment PIN_AD15  -to shine[12]  ;# LEDR12			;#	Used for indication of slide switch #12
   set_location_assignment PIN_AE15  -to shine[13]  ;# LEDR13			;#	Used for indication of slide switch #13
   set_location_assignment PIN_AF13  -to shine[14]  ;# LEDR14			;#	Used for indication of slide switch #14
   set_location_assignment PIN_AE13  -to shine[15]  ;# LEDR15			;#	Used for indication of slide switch #15
   set_location_assignment PIN_AE12  -to shine[16]  ;# LEDR16			;#	Used for indication of slide switch #16
   set_location_assignment PIN_AD12  -to shine[17]  ;# LEDR17			;#	Used for indication of slide switch #17
